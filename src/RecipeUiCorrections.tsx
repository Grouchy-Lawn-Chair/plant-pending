...
function resolvePlantIdFromDetails(input:HTMLInputElement,plan:GardenPlan){
  ...
  const named=(plan.placedPlants||[]).filter(item=>item.itemType!=='rock'&&item.plantName&&text.includes(item.plantName));
